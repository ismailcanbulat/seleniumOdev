...
public class LoginTest extends BaseTest {
    ...
    public void loginTest(){
        ...
        methods.sendKeys(By.id("login-email"), "ismail.canbulat@testinium.com");
        methods.waitBySeconds(2);
        ...
        methods.sendKeys(By.xpath("//*[@id=\"address-firstname-companyname\"]"), "Ismail");
        methods.waitBySeconds(1);
        methods.click(By.xpath("//*[@id=\"address-lastname-title\"]"));
        methods.sendKeys(By.xpath("//*[@id=\"address-lastname-title\"]"), "Canbulat");
        methods.waitBySeconds(1);
        ...
        methods.sendKeys(By.xpath("//*[@id=\"credit-card-owner\"]"),"Ismail Canbulat");
